...
const createWallet = () => {
    ...
    if (confirm('Before you continue, please close ALL other Minado browser windows. Failure to do so may result in LOSS OF ASSETS!\n\nWould you like to continue creating a new wallet?')) {
        /* Create a new wallet. */
        Wallet.createWallet()
    }
}
...
<template>
    <section class="flex flex-col gap-5">
        ...
        <p class="px-3 py-2 bg-yellow-100 text-base font-medium border-2 border-yellow-200 rounded-lg shadow-md">
            Import your existing wallet into Minado.
        </p>
