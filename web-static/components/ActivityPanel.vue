        ...
        <div class="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
            ...
            <router-link to="/order" class="cursor-pointer rounded-tl-lg rounded-tr-lg sm:rounded-tr-none relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                ...
                <div class="mt-8">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Vaalserberg (NL): <strong>7,000 - 8,000</strong> H/s
                    </p>

                    <p class="mt-2 text-sm text-gray-500">
                        Transfagarasan (RO): <strong>7,000 - 8,000</strong> H/s
                    </p>

                    <p class="mt-2 text-sm text-gray-500">
                        Kekesteto (RL): <strong>8,000 - 10,000</strong> H/s
                    </p>
                </div>
            ...
            <div class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-cyan-500">
                ...
                <div class="mt-8">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Your wallet(s) will receive a steady stream of payouts.
                        Payouts are made as pool funds mature.
                    </p>
                </div>
