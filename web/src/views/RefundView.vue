            ...
            <div class="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
                    <div>
                      ...
                      -->
                                    <label class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none ring-2 ring-indigo-500">
                        ...
                        -->
                                        <span class="pointer-events-none absolute -inset-px rounded-lg border border-indigo-500" aria-hidden="true"></span>
                                    </label>
                      ...
                      -->
                          ...
                          Heroicon name: mini/check-circle
                        -->
                                        <svg class="hidden h-5 w-5 text-indigo-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                                        </svg>
                                        <!--
                          Active: "border", Not Active: "border-2"
                            ...
                            <fieldset class="mt-4">
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div class="flex items-center">
                                        <input id="usd-coin" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="usd-coin" class="ml-3 block text-sm font-medium text-gray-700">
                                            USD Coin (USDC)
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="tether" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="tether" class="ml-3 block text-sm font-medium text-gray-700">
                                            Tether (USDT)
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="binance-usd" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="binance-usd" class="ml-3 block text-sm font-medium text-gray-700">
                                            Binance USD (BUSD)
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input id="bitcoin" name="payment-type" type="radio" checked class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="bitcoin" class="ml-3 block text-sm font-medium text-gray-700">
                                            Bitcoin (BTC)
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="bitcoin-cash" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="bitcoin-cash" class="ml-3 block text-sm font-medium text-gray-700">
                                            Bitcoin Cash (BCH)
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="dash" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="dash" class="ml-3 block text-sm font-medium text-gray-700">
                                            Dash (DASH)
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="avalanche" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="avalanche" class="ml-3 block text-sm font-medium text-gray-700">
                                            Avalanche (AVAX)
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input id="ethereum" name="payment-type" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                                        
                                        <label for="ethereum" class="ml-3 block text-sm font-medium text-gray-700">
                                            Ethereum (ETH)
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="mt-10 border-t border-gray-200 pt-10">
                            ...
                            <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                ...
                                <div class="mt-4 col-span-2 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                    <!--
                        Checked: "border-transparent", Not Checked: "border-gray-300"
                        Active: "ring-2 ring-indigo-500"
                      -->
